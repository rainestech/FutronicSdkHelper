...
public:
     ...
     */
    CFutronicSdkBase( JNIEnv *env, jobject obj, jobject ctx );
    ...
    /**
     * \brief get the "Fast mode" value
     */
    DGTBOOL getFastMode()
    {
        jboolean value = m_env->GetBooleanField( m_obj, m_bFastModeID );
        return value == JNI_FALSE ? FALSE : TRUE;
    }
